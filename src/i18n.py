...
TRANSLATIONS = {
    "id": {
        ...
        "index_cache_folder_help": "Opsional. Isi link/ID folder yang sudah dishare ke service account sebagai Editor. Jika kosong, memakai folder PDF.",
    ...
    "en": {
        ...
        "index_cache_folder_help": "Optional. Enter a folder link/ID shared with the service account as Editor. If empty, the PDF folder is used.",
